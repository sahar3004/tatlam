...
class TestBatchCmdMain:
    ...
    @patch("tatlam.cli.batch_cmd.configure_logging")
    ...
    def test_main_sync_mode(
        ...
        mock_run_batch_module = MagicMock()
        mock_run_batch_module.run_batch.return_value = mock_result

        with patch.dict(sys.modules, {"run_batch": mock_run_batch_module}):
            from tatlam.cli.batch_cmd import main

            main()

            mock_logging.assert_called_once()
            mock_run_batch_module.run_batch.assert_called_once()
    ...
    def test_main_async_mode(
        ...
        mock_run_batch_module = MagicMock()
        mock_run_batch_module.run_batch_async.return_value = mock_result
        ...
        with patch.dict(sys.modules, {"run_batch": mock_run_batch_module}):
            ...
            mock_run_batch_module.run_batch_async.assert_called_once()
            mock_exit.assert_called_with(0)
    ...
    def test_main_with_custom_owner(
        ...
        with patch.dict(sys.modules, {"run_batch": mock_run_batch_module}):
            ...
            mock_run_batch_module.run_batch.assert_called_with("Test", owner="CustomOwner")
    ...
    def test_main_handles_keyboard_interrupt(
        ...
        mock_run_batch_module = MagicMock()
        mock_run_batch_module.run_batch.side_effect = KeyboardInterrupt()
    ...
    def test_main_handles_generic_exception(
        ...
        mock_run_batch_module = MagicMock()
        mock_run_batch_module.run_batch.side_effect = Exception("Test error")
